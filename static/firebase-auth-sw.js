...
firebase.initializeApp({"apiKey":"AIzaSyAkcPGQJYUKayLiq92XSe21_e4JrMoGHsM","authDomain":"chadopedia.firebaseapp.com","databaseURL":"https:\u002F\u002Fchadopedia-default-rtdb.firebaseio.com","projectId":"chadopedia","storageBucket":"chadopedia.appspot.com","messagingSenderId":"292955403698","appId":"1:292955403698:web:14afada992e74a6235a0ab","measurementId":"G-GZ35JTJLRF"})

// Initialize authService
const authService = firebase.auth()

authService.useEmulator('http://127.0.0.1:9091')
  ...
  if (!expectsHTML || !isSameOrigin || !isHttps || isIgnored) {
    if (event.request.url.startsWith('https://www.googleapis.com/identitytoolkit/')) {
      event.respondWith(
        fetch({
          ...event.request,
          ...{ url: event.request.url.replace(/https:\/\//, 'http://127.0.0.1:9091/') }
        })
      )
